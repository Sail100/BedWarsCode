--[[
	...
	spy thing - RemoteEvent
   Kavo ui
	7GrandDadPGN  - Vape Entity
--]]
				...
				if Cape.Enabled then
				  Settings["Cape"] = true
					lplr.CharacterAdded:Connect(function(char)
						spawn(function()
							pcall(function() 
								Cape(char, "rbxassetid://1839183712")--("rbxthumb://type=Asset&id=" .. 13587951030 .. "&w=420&h=420"))
							end)
						end)
					end)
					if lplr.Character then
						spawn(function()
							pcall(function() 
								Cape(lplr.Character, "rbxassetid://1839183712") --("rbxthumb://type=Asset&id=" .. 13587951030 .. "&w=420&h=420"))
							end)
						end)
					end
				else
...
function SaveSettings()
  writefile("BedwarsCode/Profiles/AnyGame.json",game:GetService("HttpService"):JSONEncode(Settings))
end
